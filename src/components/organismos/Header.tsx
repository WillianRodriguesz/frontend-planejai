...
const Header = () => {
  return (
    <header className="fixed top-0 left-0 w-full z-50 bg-transparent backdrop-blur-md border-b-4 border-purple-600 px-6 py-4 flex items-center justify-between shadow-lg shadow-purple-600/30">
      ...
      <div className="flex items-center gap-3">
        <button
          ...
          className="text-white hover:text-violet-600 hover:bg-purple-600/15 p-3 rounded-xl transition-all duration-200 bg-transparent focus:outline-none border-none outline-none ring-0 focus:ring-0"
        >
